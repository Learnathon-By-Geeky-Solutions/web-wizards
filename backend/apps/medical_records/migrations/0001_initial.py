    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab_result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_results', to='medical_records.labresult')),
                ('test_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='medical_records.testtype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='medical_records.parameterdefinition')),
                ('test_result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameter_values', to='medical_records.testresult')),
            ],
            options={
